...
class Double_CBR(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, is_pooling=False, pool_channel=32):
        ...
        if self.is_pooling:
            self.pool = nn.Conv2d(pool_channel, pool_channel, kernel_size=(2, 2), stride=(2, 2), padding=0)
...
class Unet_Encoder(nn.Module):
    def __init__(self, in_channel=3):
        ...
        self.CBR_256 = Double_CBR(32, 64, is_pooling=True, pool_channel=32)
        self.CBR_128 = Double_CBR(64, 128, is_pooling=True, pool_channel=64)
        self.CBR_64 = Double_CBR(128, 256, is_pooling=True, pool_channel=128)
        self.CBR_32 = Double_CBR(256, 256, is_pooling=True, pool_channel=256)
...
class Base_Unet_Vgg_Simple2(nn.Module):
    """
    ...
    def __init__(self, num_class=2, in_channels=3):
        super(Base_Unet_Vgg_Simple2, self).__init__()
        print(self.__doc__)
...
if __name__ == "__main__":
    base_unet_vgg_simple = Base_Unet_Vgg_Simple2(num_class=2, in_channels=3)
